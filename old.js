...
app.post('/send-email-to-user/isApproved', authenticateToken, async(req, res) => {
...
app.post('/send-email-to-user/userNeedValidation', authenticateToken, async(req, res) => {
    const username = req.body.user.name
...
app.post('/send-email-to-user/lightPointReported', authenticateToken,async(req, res) => {
...
app.get('/users/getNotValidateUsers', authenticateToken,async function (req, res) {
    try {
...
app.get('/users/:id', authenticateToken,async function (req, res) {
    try {
...
app.get('/profile', authenticateToken, async function (req, res) {
    try {
      // The authenticateToken middleware should attach the user ID to the request
      // Assuming it adds a user property with the ID of the authenticated user
      ...
      if (user) {
        // Return the user data wrapped in a user property to match frontend expectations
        res.json({ user });
      } else {
...
app.get('/users/getForEmail/:email', authenticateToken,async function (req, res) {
    try {
...
app.get('/townHalls',authenticateToken, async (req, res) => {
    try {
...
app.get('/townHalls/:name',authenticateToken, async (req, res) => {
    try {
...
app.get('/townHalls/lightpoints/getActiveReports',authenticateToken, async (req, res) => {
    try {
...
app.get('/townHalls/lightpoints/getPoint/', authenticateToken, async (req, res) => {
    try {
        const { name, numero_palo } = req.query;
 ...
 * 
 */
app.post('/addReport',authenticateToken, async (req, res) => {
    try {
        const th = await townHalls.findOne({ name: {$eq: req.body.name} });
...
*/
app.post('/addOperation', authenticateToken,async (req, res) => {
    try {
...
app.post('/api/downloadExcelReport', authenticateToken, function (req, res) {
